      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary via-primary to-primary/95 text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:flex lg:items-center lg:gap-12 lg:px-8 lg:py-24">
          <div className="flex-1">
            ...
            <div className="mt-3">
              <OrgLogo size="sm" showName variant="light" />
            </div>
          ...
          <div className="mt-12 lg:mt-0 lg:w-80">
            <div className="mx-auto max-w-xs overflow-hidden rounded-lg border-4 border-white/20 shadow-xl">
              <PortraitImage size="hero" priority />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 leading-relaxed text-slate-600">
              Muthyala Venu is an entrepreneur, social services professional, and financial consultant based in
              Telangana. He established Aryan Filling Station (2023) and Aryan Pay Enterprises (2024), and serves
              as State Vice President – Public Grievances with AICHLS—focused on human rights awareness, public
              grievance education, and community welfare.
            </p>
            <Link
              href="/about"
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-lg border border-border bg-white p-8 shadow-sm lg:p-12">
            <div className="flex flex-col gap-6 sm:flex-row sm:items-start">
              ...
              <div className="flex-1">
                <OrgLogo size="sm" showName className="mb-4" />
                <h2 className="font-heading text-2xl font-bold text-primary">Professional Credentials</h2>
                <p className="mt-3 leading-relaxed text-slate-600">
                  {siteConfig.designation} with {siteConfig.organization.name}. Appointment certificate
                  available for verification on the credentials page.
                </p>
                <Link
                  href="/credentials#appointment-certificate"
